...
for (trajectory in c('EMDSC_MAC1','EMDSC_MAC1_MAC2','EMDSC_MMDSC','EMDSC_MMDSC_PMNMDSC','EMDSC_MMDSC-MAC1')) {
  ...
  datadir <- paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/GBM_myeloid/demean/testtime/subphate/result/', trajectory, '/data/')
  ...
  active.ident <- readRDS('/home-4/whou10@jhu.edu/data2/whou10/GBM/singleObject/M_active.ident.rds') ###
